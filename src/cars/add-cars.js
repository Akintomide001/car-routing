    ...
    return(
        <form onSubmit={handleSubmit}>
            ...
            <div>
                ...
                <input type='text' id="email" placeholder="Enter Email"  onChange={handleChange} value={carInfo.email} />
            </div>
            <div>
            ...
            <div>
                ...
                <input type='text' id="car_model" placeholder="Enter Car Model"  onChange={handleChange} value={carInfo.car_make_model}/>
            </div>
            <div>
                <label htmlFor="car_model_year">Car Model Year</label>
                <input type='text' id="car_model_year" placeholder="Enter Car Model Year"  onChange={handleChange} value={carInfo.car_make_model_year} />
            </div>
            <div>
            ...
            <div>
                ...
                <input type='url' id="avatar" placeholder="Enter Link To Avater"  onChange={handleChange} value={carInfo.avatar}/>
            </div>
